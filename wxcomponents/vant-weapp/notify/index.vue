<template>
<uni-shadow-root class="vant-weapp-notify-index"><van-transition name="slide-down" :show="show" custom-class="van-notify__container" :custom-style="'z-index: '+(zIndex)+'; top: '+(utils.addUnit(top))" @click.native="onTap">

<template>
<uni-shadow-root class="vant-weapp-progress-index"><view class="van-progress custom-class" :style="'height: '+(utils.addUnit(strokeWidth))+'; '+(trackColor ? 'background: ' + trackColor : '')">
